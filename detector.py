...
def slope_lines(image, lines):
    ...
    return cv.addWeighted(image, 1, img, 0.4, 0.0)


def weighted_img(img, initial_img, alpha=0.8, beta=1.0, theta=0.0):
...
def main():
    ...
    while cap.isOpened():
        ...
        cv.putText(
            img, "FPS: " + str(fps), (50, 50), font, 1, (0, 255, 255), 2, cv.LINE_4
        )
